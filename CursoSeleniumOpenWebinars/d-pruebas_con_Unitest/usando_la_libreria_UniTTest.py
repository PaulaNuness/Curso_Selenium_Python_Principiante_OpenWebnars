...
########################################################################################################################
    ...
    def test_dos(self):
        print("\033[92mSoy el test 2\033[0m")  # Verde
        ...
        try:
            ...
            # ahora vamos comprobar que eu titulo de la pagina es Wikipedia, la enciclopedia libre.
            titulo = self.driver.title
            self.assertEqual("Wikipedia, la enciclopedia libre",titulo) # esta correcto

            print("\033[92mTest 2 concluido con suceso!!!\033[0m")  # Verde
        except Exception as e:
            self.fail(f"\033[91mEl test 1 falló: {e}\033[0m")  # Rojo
